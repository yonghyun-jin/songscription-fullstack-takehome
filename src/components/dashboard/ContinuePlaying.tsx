...
export function ContinuePlaying({ song, onContinue }: ContinuePlayingProps) {
  return (
    <div className="bg-white border-4 border-gray-800 rounded-xl p-6 mb-8 shadow-lg">
      <div className="flex items-center gap-2 mb-4">
        <span className="text-blue-600 font-semibold text-lg uppercase tracking-wide">Continue Playing</span>
      </div>
      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={onContinue}
              className="bg-blue-500 text-white px-5 py-2.5 rounded-xl text-lg font-medium border-2 border-gray-800
                         hover:bg-blue-600 transition-colors flex items-center gap-2 shadow-md"
            >
              <PlayIcon />
              Open practice view
            </button>
            <span className="text-gray-400 text-lg">{formatTimeAgo(song.lastPracticedAt)}</span>
          </div>
        </div>

        {/* Piano roll visualization */}
        <div className="w-96 h-40 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl overflow-hidden flex-shrink-0 border-4 border-gray-800">
